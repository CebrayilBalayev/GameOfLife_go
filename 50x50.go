...
func main() {
	start := true
	timeToRefresh := time.Second / 10
	minTimeToRefresh := time.Second / 100
	...
	button2 := widget.NewButton("p/p", func() {
		start = !start
	})
	...
	buttons := container.NewVBox(button1, button2, button3, myLabel, button4)
